...
class GlusterNagiosTestCase(unittest.TestCase):
...
class GlusterNagiosTestResult(result.TextTestResult):
    def __init__(self, *args, **kwargs):
...
class GlusterNagiosTestRunner(core.TextTestRunner):
    def __init__(self, *args, **kwargs):
        core.TextTestRunner.__init__(self, *args, **kwargs)

    def _makeResult(self):
        return GlusterNagiosTestResult(self.stream,
                                       self.descriptions,
                                       self.verbosity,
                                       self.config)
